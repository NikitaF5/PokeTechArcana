"""Build the launcher overlay for the complete corrected quest book."""
...
OUT = QUEST / "release-1.15.1"
PREVIOUS_MANIFEST = QUEST / "release-1.5.0" / "manifest.json"
...
manifest["pack_version"] = "1.15.1"
manifest["config_zip"] = {
    "url": "https://github.com/NikitaF5/PokeTechArcana/releases/download/pack-v1.15.1/configs.zip",
    "sha1": sha1(configs),
}
