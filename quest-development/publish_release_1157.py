"""Publish the 1.15.7 approved ATM-style quest layout update."""
...
OUT = ROOT / "quest-development" / "release-1.15.7"
...
payload = {
    ...
    "name": "PokeTech Arcana 1.15.7 — утверждённая разметка квестов",
    "body": "41 квестовая глава перестроена по утверждённым макетам. Предпросмотр и игровые SNBT используют общий модуль координат и зависимостей; линии отрисованы в книжном фоне, поэтому композиция в игре соответствует макету. Первые три главы не изменены.",
    "make_latest": "true",
}
try:
