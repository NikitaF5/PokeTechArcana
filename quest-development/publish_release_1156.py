"""Publish the 1.15.6 varied quest route update."""
...
OUT = ROOT / "quest-development" / "release-1.15.6"
...
payload = {
    ...
    "name": "PokeTech Arcana 1.15.6 — разнообразные маршруты квестов",
    "body": "Круговая разметка удалена. Квестовые ветки получили разные читаемые маршруты: дуги, петли, ромбы, волны, лестницы и сходящиеся переходы. Фон теперь содержит только книжную рамку и легенду этапов. ID и прогресс игроков сохранены.",
    "make_latest": "true",
}
try:
