"""Publish the 1.15.1 client overlay to GitHub Releases."""
...
OUT = ROOT / "quest-development" / "release-1.15.1"
...
payload = {
    ...
    "name": "PokeTech Arcana 1.15.1 — исправление книги квестов",
    "body": "Исправлены названия всех 45 глав, доставка фоновых текстур и читаемость описаний, целей и наград.",
    "make_latest": "true",
}
try:
