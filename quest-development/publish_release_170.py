...
OUT = ROOT / "quest-development" / "release-1.7.0"
...
payload = {"tag_name": TAG, "target_commitish": "main", "name": "PokeTech Arcana 1.7.0 — Iron's Spells, Farmer's Delight и Mystical Agriculture", "body": "Добавлены три полные квестовые главы: Iron's Spells, Farmer's Delight и Mystical Agriculture.", "make_latest": "true"}
try:
