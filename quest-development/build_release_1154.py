"""Build the launcher overlay for contextual quest descriptions and rewards."""
...
OUT = QUEST / "release-1.15.4"
PREVIOUS_MANIFEST = QUEST / "release-1.15.3" / "manifest.json"
...
manifest["pack_version"] = "1.15.4"
manifest["config_zip"] = {
    "url": "https://github.com/NikitaF5/PokeTechArcana/releases/download/pack-v1.15.4/configs.zip",
    "sha1": sha1(configs),
}
