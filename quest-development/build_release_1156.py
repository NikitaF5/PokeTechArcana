"""Build launcher overlay for the varied route-based quest layouts."""
...
OUT = QUEST / "release-1.15.6"
PREVIOUS_MANIFEST = QUEST / "release-1.15.5" / "manifest.json"
...
manifest["pack_version"] = "1.15.6"
manifest["config_zip"] = {
    "url": "https://github.com/NikitaF5/PokeTechArcana/releases/download/pack-v1.15.6/configs.zip",
    "sha1": sha1(configs),
}
