...
previous = json.loads((QUEST / "release-1.5.0" / "manifest.json").read_text("utf-8"))
previous["pack_version"] = "1.6.0"
previous["config_zip"] = {
    "url": "https://github.com/NikitaF5/PokeTechArcana/releases/download/pack-v1.6.0/configs.zip",
    "sha1": sha1(configs),
}
