"""Publish the 1.15.2 quest grouping update to GitHub Releases."""
...
OUT = ROOT / "quest-development" / "release-1.15.2"
...
payload = {
    ...
    "name": "PokeTech Arcana 1.15.2 — разделы книги квестов",
    "body": "Все 45 квестовых глав распределены по 7 сворачиваемым тематическим разделам. Исправлено форматирование названия Forbidden & Arcanus. ID заданий и прогресс игроков сохранены.",
    "make_latest": "true",
}
try:
