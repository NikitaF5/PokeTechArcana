"""Publish the 1.15.3 quest background alignment update."""
...
OUT = ROOT / "quest-development" / "release-1.15.3"
...
payload = {
    ...
    "name": "PokeTech Arcana 1.15.3 — выравнивание карт квестов",
    "body": "Во всех 41 главах с круговой разметкой области подогнаны под реальные координаты квестов, а цветные маршруты синхронизированы с зависимостями FTB Quests. ID и прогресс игроков сохранены.",
    "make_latest": "true",
}
try:
