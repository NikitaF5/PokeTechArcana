"""Build the launcher overlay for the grouped quest book."""
...
OUT = QUEST / "release-1.15.2"
PREVIOUS_MANIFEST = QUEST / "release-1.15.1" / "manifest.json"
...
manifest["pack_version"] = "1.15.2"
manifest["config_zip"] = {
    "url": "https://github.com/NikitaF5/PokeTechArcana/releases/download/pack-v1.15.2/configs.zip",
    "sha1": sha1(configs),
}
