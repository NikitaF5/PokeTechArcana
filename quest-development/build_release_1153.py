"""Build the launcher overlay for aligned quest chapter backgrounds."""
...
OUT = QUEST / "release-1.15.3"
PREVIOUS_MANIFEST = QUEST / "release-1.15.2" / "manifest.json"
...
manifest["pack_version"] = "1.15.3"
manifest["config_zip"] = {
    "url": "https://github.com/NikitaF5/PokeTechArcana/releases/download/pack-v1.15.3/configs.zip",
    "sha1": sha1(configs),
}
