"""Publish the 1.15.4 quest descriptions and rewards update."""
...
OUT = ROOT / "quest-development" / "release-1.15.4"
...
payload = {
    ...
    "name": "PokeTech Arcana 1.15.4 — понятные задания и полезные награды",
    "body": "Обновлены описания и награды всех 3751 квестов. Описания объясняют получение и применение целей, награды соответствуют моду и этапу развития, а редкие готовые предметы исключены. ID и прогресс игроков сохранены.",
    "make_latest": "true",
}
try:
